package com.kpihx_labs.myway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.kpihx_labs.myway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.kpihx_labs.myway.security.DomainUserDetailsService", "createSpringSecurityUser");
