        ...
        http
            ...
            .authorizeExchange(
                ...
                authz
                    ...
                    .pathMatchers("/api/admin/**").hasAuthority(AuthoritiesConstants.DEVS)
                    ...
                    .pathMatchers("/management/**").hasAuthority(AuthoritiesConstants.DEVS)
            )
