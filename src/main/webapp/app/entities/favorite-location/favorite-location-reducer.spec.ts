...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './favorite-location.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FAVORITELOCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FAVORITELOCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FAVORITELOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FAVORITELOCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FAVORITELOCATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FAVORITELOCATION actions', async () => {
      const arg = 42666;
