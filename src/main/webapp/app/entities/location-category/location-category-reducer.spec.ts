...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './location-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCATIONCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOCATIONCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOCATIONCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOCATIONCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOCATIONCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOCATIONCATEGORY actions', async () => {
      const arg = 42666;
