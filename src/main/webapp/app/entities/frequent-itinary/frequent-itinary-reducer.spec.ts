...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FREQUENTITINARY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FREQUENTITINARY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FREQUENTITINARY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FREQUENTITINARY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FREQUENTITINARY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FREQUENTITINARY actions', async () => {
      const arg = 42666;
