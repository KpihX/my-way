...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLACECATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PLACECATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PLACECATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PLACECATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PLACECATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PLACECATEGORY actions', async () => {
      const arg = 42666;
