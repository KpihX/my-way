  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myWayApp.placeCategory.home.createOrEditLabel" data-cy="PlaceCategoryCreateUpdateHeading">
            <Translate contentKey="myWayApp.placeCategory.home.createOrEditLabel">Create or edit a PlaceCategory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('myWayApp.placeCategory.name')}
