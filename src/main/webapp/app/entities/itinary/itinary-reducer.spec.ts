...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './itinary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITINARY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ITINARY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ITINARY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ITINARY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ITINARY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ITINARY actions', async () => {
      const arg = 42666;
