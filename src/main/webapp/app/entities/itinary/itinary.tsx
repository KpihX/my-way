            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('distance')}>
                  ...
                  <FontAwesomeIcon icon={getSortIconByFieldName('distance')} />
                </th>
                ...
                <th className="hand" onClick={sort('polyline')}>
                  <Translate contentKey="myWayApp.itinary.polyline">Polyline</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('polyline')} />
                </th>
                <th>
                  <Translate contentKey="myWayApp.itinary.location">Location</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {itinaryList.map((itinary, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{itinary.distance}</td>
                  <td>{itinary.duration}</td>
                  <td>{itinary.polyline}</td>
                  <td>
                    {itinary.locations
                      ? itinary.locations.map((val, j) => (
                          <span key={j}>
                            <Link to={`/location/${val.id}`}>{val.name}</Link>
                            {j === itinary.locations.length - 1 ? '' : ', '}
                          </span>
                        ))
                      : null}
                  </td>
